...
public class SacredwoodLogBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:sacredwood_log")
	public static final Block block = null;

	public SacredwoodLogBlock(OriginofspiritsModElements instance) {
		super(instance, 568);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD, MaterialColor.LIGHT_GRAY).sound(SoundType.WOOD).hardnessAndResistance(2f, 2f).setLightLevel(s -> 0).harvestLevel(-1)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("sacredwood_log");
		}
