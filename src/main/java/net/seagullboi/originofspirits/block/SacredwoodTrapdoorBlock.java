...
public class SacredwoodTrapdoorBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:sacredwood_trapdoor")
	public static final Block block = null;

	public SacredwoodTrapdoorBlock(OriginofspiritsModElements instance) {
		super(instance, 594);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sacredwood_trapdoor");
		}
