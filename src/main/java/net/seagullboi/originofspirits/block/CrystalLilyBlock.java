...
public class CrystalLilyBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:crystal_lily")
	public static final Block block = null;

	public CrystalLilyBlock(OriginofspiritsModElements instance) {
		super(instance, 853);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("crystal_lily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:crystal_lily"), configuredFeature);
		}
	}
