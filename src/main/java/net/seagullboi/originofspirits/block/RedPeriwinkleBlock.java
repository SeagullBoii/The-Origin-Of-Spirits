...
public class RedPeriwinkleBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:red_periwinkle")
	public static final Block block = null;

	public RedPeriwinkleBlock(OriginofspiritsModElements instance) {
		super(instance, 558);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_periwinkle"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:red_periwinkle"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("red_periwinkle");
		}
