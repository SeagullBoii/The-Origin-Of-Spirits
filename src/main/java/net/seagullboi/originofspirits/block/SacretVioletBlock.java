...
public class SacretVioletBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:sacret_violet")
	public static final Block block = null;

	public SacretVioletBlock(OriginofspiritsModElements instance) {
		super(instance, 562);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sacret_violet"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:sacret_violet"), configuredFeature);
		}
	}
