...
public class StrippedSacredwoodLogBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:stripped_sacredwood_log")
	public static final Block block = null;

	public StrippedSacredwoodLogBlock(OriginofspiritsModElements instance) {
		super(instance, 589);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD, MaterialColor.PURPLE).sound(SoundType.WOOD).hardnessAndResistance(2f, 2f).setLightLevel(s -> 0).harvestLevel(-1)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("stripped_sacredwood_log");
		}
