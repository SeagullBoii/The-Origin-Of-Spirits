...
public class SwirlwoodFenceGateBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:swirlwood_fence_gate")
	public static final Block block = null;

	public SwirlwoodFenceGateBlock(OriginofspiritsModElements instance) {
		super(instance, 793);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("swirlwood_fence_gate");
		}
