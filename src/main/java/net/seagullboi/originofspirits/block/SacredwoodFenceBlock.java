...
public class SacredwoodFenceBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:sacredwood_fence")
	public static final Block block = null;

	public SacredwoodFenceBlock(OriginofspiritsModElements instance) {
		super(instance, 573);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("sacredwood_fence");
		}
