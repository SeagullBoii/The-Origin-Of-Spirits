...
public class SacredwoodStairsBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:sacredwood_stairs")
	public static final Block block = null;

	public SacredwoodStairsBlock(OriginofspiritsModElements instance) {
		super(instance, 571);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.WOOD, MaterialColor.PURPLE).sound(SoundType.WOOD).hardnessAndResistance(3f, 2f).setLightLevel(s -> 0)
			...
			setRegistryName("sacredwood_stairs");
		}
