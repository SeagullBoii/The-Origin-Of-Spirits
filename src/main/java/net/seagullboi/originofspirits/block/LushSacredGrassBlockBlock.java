...
import net.seagullboi.originofspirits.procedures.LushSacredGrassBlockTickProcedure;
...
public class LushSacredGrassBlockBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:lush_sacred_grass_block")
	public static final Block block = null;

	public LushSacredGrassBlockBlock(OriginofspiritsModElements instance) {
		super(instance, 930);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lush_sacred_grass_block");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			LushSacredGrassBlockTickProcedure.executeProcedure(Stream
