...
public class StrippedSacredwoodBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:stripped_sacredwood")
	public static final Block block = null;

	public StrippedSacredwoodBlock(OriginofspiritsModElements instance) {
		super(instance, 588);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_sacredwood");
		}
