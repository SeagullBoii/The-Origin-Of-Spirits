...
public class PeaceLilyBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:peace_lily")
	public static final Block block = null;

	public PeaceLilyBlock(OriginofspiritsModElements instance) {
		super(instance, 563);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("peace_lily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:peace_lily"), configuredFeature);
		}
	}
