...
public class SwirlwoodDoorBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:swirlwood_door")
	public static final Block block = null;

	public SwirlwoodDoorBlock(OriginofspiritsModElements instance) {
		super(instance, 796);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("swirlwood_door");
		}
