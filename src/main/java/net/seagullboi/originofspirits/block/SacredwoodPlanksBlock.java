...
public class SacredwoodPlanksBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:sacredwood_planks")
	public static final Block block = null;

	public SacredwoodPlanksBlock(OriginofspiritsModElements instance) {
		super(instance, 569);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sacredwood_planks");
		}
