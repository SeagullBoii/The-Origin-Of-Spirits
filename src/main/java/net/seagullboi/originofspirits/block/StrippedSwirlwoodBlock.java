...
public class StrippedSwirlwoodBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:stripped_swirlwood")
	public static final Block block = null;

	public StrippedSwirlwoodBlock(OriginofspiritsModElements instance) {
		super(instance, 795);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD,  MaterialColor.SAND).sound(SoundType.WOOD).hardnessAndResistance(2f, 2f).setLightLevel(s -> 0).harvestLevel(-1)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("stripped_swirlwood");
		}
