...
public class OrangePeriwinkleBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:orange_periwinkle")
	public static final Block block = null;

	public OrangePeriwinkleBlock(OriginofspiritsModElements instance) {
		super(instance, 560);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("orange_periwinkle"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:orange_periwinkle"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("orange_periwinkle");
		}
