...
public class MagicMagnoliaBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:magic_magnolia")
	public static final Block block = null;

	public MagicMagnoliaBlock(OriginofspiritsModElements instance) {
		super(instance, 885);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("magic_magnolia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:magic_magnolia"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("magic_magnolia");
		}
