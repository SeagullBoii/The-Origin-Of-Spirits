...
public class SmenerelOreBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:smenerel_ore")
	public static final Block block = null;

	public SmenerelOreBlock(OriginofspiritsModElements instance) {
		super(instance, 779);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("originofspirits:smenerel_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("smenerel_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:smenerel_ore"), configuredFeature);
		}
	}
