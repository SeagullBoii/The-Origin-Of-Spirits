...
public class BlessedRoseBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:blessed_rose")
	public static final Block block = null;

	public BlessedRoseBlock(OriginofspiritsModElements instance) {
		super(instance, 561);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blessed_rose"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:blessed_rose"), configuredFeature);
		}
	}
