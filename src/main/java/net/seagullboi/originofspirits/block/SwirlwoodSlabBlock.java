...
public class SwirlwoodSlabBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:swirlwood_slab")
	public static final Block block = null;

	public SwirlwoodSlabBlock(OriginofspiritsModElements instance) {
		super(instance, 791);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("swirlwood_slab");
		}
