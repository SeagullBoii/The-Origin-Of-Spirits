...
import net.seagullboi.originofspirits.procedures.CrystalbackTurtleSpawnProcedure;
...
public class TempestSpikeFakeBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:tempest_spike_fake")
	public static final Block block = null;

	public TempestSpikeFakeBlock(OriginofspiritsModElements instance) {
		super(instance, 407);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tempest_spike_fake"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:tempest_spike_fake"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SPEED, 100, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.GLASS)
					.hardnessAndResistance(0.2f, 0.5f).setLightLevel(s -> 0));
			setRegistryName("tempest_spike_fake");
		}
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			CrystalbackTurtleSpawnProcedure.executeProcedure(Stream
