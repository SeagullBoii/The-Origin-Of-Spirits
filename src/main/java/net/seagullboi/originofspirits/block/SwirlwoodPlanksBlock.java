...
public class SwirlwoodPlanksBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:swirlwood_planks")
	public static final Block block = null;

	public SwirlwoodPlanksBlock(OriginofspiritsModElements instance) {
		super(instance, 788);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("swirlwood_planks");
		}
