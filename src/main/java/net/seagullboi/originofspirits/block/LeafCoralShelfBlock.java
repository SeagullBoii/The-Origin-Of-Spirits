...
public class LeafCoralShelfBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:leaf_coral_shelf")
	public static final Block block = null;

	public LeafCoralShelfBlock(OriginofspiritsModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("leaf_coral_shelf");
		}
