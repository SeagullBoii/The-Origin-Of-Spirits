...
public class StripepdSwirlwoodwoodBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:stripepd_swirlwoodwood")
	public static final Block block = null;

	public StripepdSwirlwoodwoodBlock(OriginofspiritsModElements instance) {
		super(instance, 798);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripepd_swirlwoodwood");
		}
