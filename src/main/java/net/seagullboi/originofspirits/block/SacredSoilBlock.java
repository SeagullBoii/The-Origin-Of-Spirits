...
import net.seagullboi.originofspirits.procedures.SacredSoilUpdateTickProcedure;
...
public class SacredSoilBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:sacred_soil")
	public static final Block block = null;

	public SacredSoilBlock(OriginofspiritsModElements instance) {
		super(instance, 530);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SacredSoilUpdateTickProcedure.executeProcedure(Stream
