...
public class SwirlwoodLogBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:swirlwood_log")
	public static final Block block = null;

	public SwirlwoodLogBlock(OriginofspiritsModElements instance) {
		super(instance, 787);
	}
