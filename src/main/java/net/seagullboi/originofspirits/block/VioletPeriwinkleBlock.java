...
public class VioletPeriwinkleBlock extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:violet_periwinkle")
	public static final Block block = null;

	public VioletPeriwinkleBlock(OriginofspiritsModElements instance) {
		super(instance, 559);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("violet_periwinkle"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:violet_periwinkle"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("violet_periwinkle");
		}
