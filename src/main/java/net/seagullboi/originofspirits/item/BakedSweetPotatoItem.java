...
public class BakedSweetPotatoItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:baked_sweet_potato")
	public static final Item block = null;

	public BakedSweetPotatoItem(OriginofspiritsModElements instance) {
		super(instance, 905);
	}
		...
		public FoodItemCustom() {
			super(new Item.Properties().group(OriginOfSpiritsFoodItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(7).saturation(1f)
							...
							.build()));
			setRegistryName("baked_sweet_potato");
		}
