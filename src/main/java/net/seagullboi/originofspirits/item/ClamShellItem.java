...
public class ClamShellItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:clam_shell")
	public static final Item block = null;

	public ClamShellItem(OriginofspiritsModElements instance) {
		super(instance, 53);
	}
