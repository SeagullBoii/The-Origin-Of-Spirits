...
public class HexayoshHornItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:hexayosh_horn")
	public static final Item block = null;

	public HexayoshHornItem(OriginofspiritsModElements instance) {
		super(instance, 759);
	}
