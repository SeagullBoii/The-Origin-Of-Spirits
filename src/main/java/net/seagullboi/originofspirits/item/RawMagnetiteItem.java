...
public class RawMagnetiteItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:raw_magnetite")
	public static final Item block = null;

	public RawMagnetiteItem(OriginofspiritsModElements instance) {
		super(instance, 541);
	}
