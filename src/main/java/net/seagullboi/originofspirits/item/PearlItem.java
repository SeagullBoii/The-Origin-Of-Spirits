...
public class PearlItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:pearl")
	public static final Item block = null;

	public PearlItem(OriginofspiritsModElements instance) {
		super(instance, 54);
	}
