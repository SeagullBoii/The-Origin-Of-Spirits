...
public class BarleyStackItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:barley_stack")
	public static final Item block = null;

	public BarleyStackItem(OriginofspiritsModElements instance) {
		super(instance, 720);
	}
