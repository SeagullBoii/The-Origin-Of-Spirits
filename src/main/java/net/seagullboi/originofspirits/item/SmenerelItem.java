...
public class SmenerelItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:smenerel")
	public static final Item block = null;

	public SmenerelItem(OriginofspiritsModElements instance) {
		super(instance, 780);
	}
