...
public class FriesItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:fries")
	public static final Item block = null;

	public FriesItem(OriginofspiritsModElements instance) {
		super(instance, 915);
	}
