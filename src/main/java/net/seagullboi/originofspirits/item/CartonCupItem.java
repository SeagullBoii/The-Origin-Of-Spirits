...
public class CartonCupItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:carton_cup")
	public static final Item block = null;

	public CartonCupItem(OriginofspiritsModElements instance) {
		super(instance, 912);
	}
