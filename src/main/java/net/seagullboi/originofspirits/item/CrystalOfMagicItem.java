...
public class CrystalOfMagicItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:crystal_of_magic")
	public static final Item block = null;

	public CrystalOfMagicItem(OriginofspiritsModElements instance) {
		super(instance, 279);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("crystal_of_magic");
		}
