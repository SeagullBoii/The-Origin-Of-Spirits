...
import net.seagullboi.originofspirits.procedures.SacWandProjectileHitProcedure;
...
public class SacWandItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:sac_wand")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletsac_wand").setRegistryName("entitybulletsac_wand");

	public SacWandItem(OriginofspiritsModElements instance) {
		super(instance, 952);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SacWandRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A727 \u00A72Magic \u00A72Damage"));
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			SacWandProjectileHitProcedure.executeProcedure(Stream
		...
		public void tick() {
			...
			SacWandBulletTickProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
