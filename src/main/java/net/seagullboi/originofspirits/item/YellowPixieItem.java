...
public class YellowPixieItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:yellow_pixie")
	public static final Item block = null;

	public YellowPixieItem(OriginofspiritsModElements instance) {
		super(instance, 714);
	}
