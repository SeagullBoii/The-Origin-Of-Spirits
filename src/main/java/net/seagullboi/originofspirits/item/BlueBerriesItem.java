...
import net.seagullboi.originofspirits.procedures.BlueBerriesRightClickedOnBlockProcedure;
...
public class BlueBerriesItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:blueberries")
	public static final Item block = null;

	public BlueBerriesItem(OriginofspiritsModElements instance) {
		super(instance, 352);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			BlueBerriesRightClickedOnBlockProcedure.executeProcedure(Stream
