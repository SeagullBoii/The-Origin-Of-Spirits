...
public class YeastItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:yeast")
	public static final Item block = null;

	public YeastItem(OriginofspiritsModElements instance) {
		super(instance, 632);
	}
