...
public class MagnetiteIngotItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:magnetite_ingot")
	public static final Item block = null;

	public MagnetiteIngotItem(OriginofspiritsModElements instance) {
		super(instance, 542);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magnetite_ingot");
		}
