...
public class RawTrenchonItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:raw_trenchon")
	public static final Item block = null;

	public RawTrenchonItem(OriginofspiritsModElements instance) {
		super(instance, 353);
	}
