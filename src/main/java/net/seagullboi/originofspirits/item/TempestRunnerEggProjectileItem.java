...
public class TempestRunnerEggProjectileItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:tempest_runner_egg_projectile")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybullettempest_runner_egg_projectile").setRegistryName("entitybullettempest_runner_egg_projectile");

	public TempestRunnerEggProjectileItem(OriginofspiritsModElements instance) {
		super(instance, 451);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TempestRunnerEggProjectileRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("tempest_runner_egg_projectile");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					TempestRunnerEggProjectileRangedItemUsedProcedure.executeProcedure(Stream
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			TempestRunnerEggProjectileProjectileHitsBlockProcedure.executeProcedure(Stream
