...
public class SmenerelCoinItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:smenerel_coin")
	public static final Item block = null;

	public SmenerelCoinItem(OriginofspiritsModElements instance) {
		super(instance, 778);
	}
