...
public class GreenPixieItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:green_pixie")
	public static final Item block = null;

	public GreenPixieItem(OriginofspiritsModElements instance) {
		super(instance, 712);
	}
