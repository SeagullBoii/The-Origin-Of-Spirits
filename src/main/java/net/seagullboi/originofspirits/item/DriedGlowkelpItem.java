...
public class DriedGlowkelpItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:dried_glowkelp")
	public static final Item block = null;

	public DriedGlowkelpItem(OriginofspiritsModElements instance) {
		super(instance, 167);
	}
		...
		public FoodItemCustom() {
			super(new Item.Properties().group(OriginOfSpiritsFoodItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(1).saturation(0.2f)
							...
							.build()));
			setRegistryName("dried_glowkelp");
		}
