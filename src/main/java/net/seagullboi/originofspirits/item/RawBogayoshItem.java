...
public class RawBogayoshItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:raw_bogayosh")
	public static final Item block = null;

	public RawBogayoshItem(OriginofspiritsModElements instance) {
		super(instance, 920);
	}
