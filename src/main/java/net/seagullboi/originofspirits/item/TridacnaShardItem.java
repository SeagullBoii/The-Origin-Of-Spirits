...
public class TridacnaShardItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:tridacna_shard")
	public static final Item block = null;

	public TridacnaShardItem(OriginofspiritsModElements instance) {
		super(instance, 327);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tridacna_shard");
		}
