...
public class TempestFeatherItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:tempest_feather")
	public static final Item block = null;

	public TempestFeatherItem(OriginofspiritsModElements instance) {
		super(instance, 429);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tempest_feather");
		}
