...
import net.seagullboi.originofspirits.procedures.BeansClickedProcedure;
...
public class BeansItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:beans")
	public static final Item block = null;

	public BeansItem(OriginofspiritsModElements instance) {
		super(instance, 390);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			BeansClickedProcedure.executeProcedure(Stream
