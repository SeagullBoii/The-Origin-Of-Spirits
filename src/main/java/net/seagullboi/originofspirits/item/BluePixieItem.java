...
public class BluePixieItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:blue_pixie")
	public static final Item block = null;

	public BluePixieItem(OriginofspiritsModElements instance) {
		super(instance, 711);
	}
