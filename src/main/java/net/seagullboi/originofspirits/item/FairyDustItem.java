...
public class FairyDustItem extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:fairy_dust")
	public static final Item block = null;

	public FairyDustItem(OriginofspiritsModElements instance) {
		super(instance, 716);
	}
