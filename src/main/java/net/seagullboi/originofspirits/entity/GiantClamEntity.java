...
public class GiantClamEntity extends OriginofspiritsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(2f, 2f)).build("giant_clam").setRegistryName("giant_clam");

	public GiantClamEntity(OriginofspiritsModElements instance) {
		super(instance, 301);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GiantClamRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7364179, -7368522, new Item.Properties().group(OriginOfSpiritsEntitiesItemGroup.tab))
				.setRegistryName("giant_clam_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(GiantClamItemItem.block));
			...
			this.inventoryArmorDropChances[EquipmentSlotType.OFFHAND.getIndex()] = -1.0F;
