...
public class BloodyClamEntity extends OriginofspiritsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.7f)).build("bloody_clam").setRegistryName("bloody_clam");

	public BloodyClamEntity(OriginofspiritsModElements instance) {
		super(instance, 252);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BloodyClamRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4747932, -2177135, new Item.Properties().group(OriginOfSpiritsEntitiesItemGroup.tab))
				.setRegistryName("bloody_clam_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(7, new BreakBlockGoal(Blocks.TURTLE_EGG, this, 1, (int) 3));
		}
		...
		public void baseTick() {
			...
			BloodyClamOnEntityTickUpdateProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
