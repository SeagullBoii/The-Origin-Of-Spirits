...
public class CrystalbackTurtleEntity extends OriginofspiritsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 0.8f)).build("crystalback_turtle").setRegistryName("crystalback_turtle");

	public CrystalbackTurtleEntity(OriginofspiritsModElements instance) {
		super(instance, 408);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CrystalbackTurtleRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9277863, -10825538, new Item.Properties().group(OriginOfSpiritsEntitiesItemGroup.tab))
				.setRegistryName("crystalback_turtle_spawn_egg"));
	}
