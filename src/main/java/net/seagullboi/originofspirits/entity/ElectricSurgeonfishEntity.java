...
public class ElectricSurgeonfishEntity extends OriginofspiritsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.5f)).build("electric_surgeonfish").setRegistryName("electric_surgeonfish");

	public ElectricSurgeonfishEntity(OriginofspiritsModElements instance) {
		super(instance, 247);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ElectricSurgeonfishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12430935, -12591370, new Item.Properties().group(OriginOfSpiritsEntitiesItemGroup.tab))
				.setRegistryName("electric_surgeonfish_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			ElectricSurgeonfishEntityDiesProcedure.executeProcedure(Stream
