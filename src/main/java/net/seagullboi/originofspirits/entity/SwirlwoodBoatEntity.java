...
public class SwirlwoodBoatEntity extends BoatEntity {
    private static final DataParameter<String> WOOD_TYPE
            = EntityDataManager.createKey(SwirlwoodBoatEntity.class, DataSerializers.STRING);

    public SwirlwoodBoatEntity(EntityType<? extends BoatEntity> type, World world) {
        super(type, world);
        this.preventEntitySpawning = true;
    }

    public SwirlwoodBoatEntity(World worldIn, double x, double y, double z) {
        this(TOOSEntityTypes.SWIRLWOOD_BOAT.get(), worldIn);
    ...
    protected void registerData() {
        super.registerData();
        this.dataManager.register(WOOD_TYPE, "swirlwood");
    }
    ...
    public Item getItemBoat() {
        switch(this.getWoodType()) {
            case "redwood":
                return TOOSItems.SWIRLWOOD_BOAT.get();
            default:
                return TOOSItems.SWIRLWOOD_BOAT.get();
        }
    }
