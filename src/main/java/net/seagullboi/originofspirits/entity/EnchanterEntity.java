...
public class EnchanterEntity extends OriginofspiritsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("enchanter").setRegistryName("enchanter");

	public EnchanterEntity(OriginofspiritsModElements instance) {
		super(instance, 235);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EnchanterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8902333, -6710887, new Item.Properties().group(OriginOfSpiritsEntitiesItemGroup.tab))
				.setRegistryName("enchanter_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			EnchanterOnEntityTickUpdateProcedure.executeProcedure(Collections.EMPTY_MAP);
		}
	}
}
