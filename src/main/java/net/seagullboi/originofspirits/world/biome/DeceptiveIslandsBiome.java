...
public class DeceptiveIslandsBiome extends OriginofspiritsModElements.ModElement {
	public static Biome biome;

	public DeceptiveIslandsBiome(OriginofspiritsModElements instance) {
		super(instance, 731);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(TOOSBlocks.SACRED_GRASS.get().getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("originofspirits:deceptive_islands"));
			}
		}
	}
