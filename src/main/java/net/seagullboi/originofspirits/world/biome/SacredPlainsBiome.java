...
public class SacredPlainsBiome extends OriginofspiritsModElements.ModElement {
	public static Biome biome;

	public SacredPlainsBiome(OriginofspiritsModElements instance) {
		super(instance, 566);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("originofspirits:sacred_plains"));
			}
		}
	}
