...
import net.seagullboi.originofspirits.procedures.CursedCaveStructureOnStructureInstanceGeneratedProcedure;
...
public class CursedCaveStructureStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000000) {
						...
						for (int a = 0; a < count; a++) {
							...
							boolean blockCriteria = blockAt.getBlock() == TOOSBlocks.BLESSED_STONE.get();
							if (blockAt.getBlock() == Blocks.STONE)
								blockCriteria = true;
							if (blockAt.getBlock() == TOOSBlocks.DECEPTONE.get())
								blockCriteria = true;
							if (!blockCriteria)
								continue;
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("originofspirits", "cursed_cave"));
							if (template == null)
								return false;
							...
							CursedCaveStructureOnStructureInstanceGeneratedProcedure.executeProcedure(Stream
			...
			event.getRegistry().register(feature.setRegistryName("cursed_cave_structure"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:cursed_cave_structure"),
					configuredFeature);
		}
	}
