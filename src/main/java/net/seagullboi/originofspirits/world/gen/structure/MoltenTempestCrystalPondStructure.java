...
public class MoltenTempestCrystalPondStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
					...
					if ((random.nextInt(1000000) + 1) <= 400000) {
						...
						for (int a = 0; a < count; a++) {
							...
							boolean blockCriteria = blockAt.getBlock() == net.seagullboi.originofspirits.registry.TOOSBlocks.ALCYONEUM_POLYPS.get();
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("originofspirits", "molten_tempest_crystal_pond"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("molten_tempest_crystal_pond"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:molten_tempest_crystal_pond"),
					configuredFeature);
		}
	}
