...
import net.seagullboi.originofspirits.procedures.Glowkelp6CondProcedure;
...
public class Glowkelp6Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
					...
					if ((random.nextInt(1000000) + 1) <= 100000) {
						...
						for (int a = 0; a < count; a++) {
							...
							int y = spawnTo.getY();
							int z = spawnTo.getZ();
							if (!Glowkelp6CondProcedure.executeProcedure(Stream
			...
			event.getRegistry().register(feature.setRegistryName("glowkelp_6"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:glowkelp_6"), configuredFeature);
		}
	}
