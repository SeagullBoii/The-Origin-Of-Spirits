...
public class HorshoeCrabSpawnStructure {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new Feature<NoFeatureConfig>(NoFeatureConfig.field_236558_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
					...
					boolean dimensionCriteria = dimensionType == World.THE_END;
			...
			event.getRegistry().register(feature.setRegistryName("horshoe_crab_spawn"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("originofspirits:horshoe_crab_spawn"), configuredFeature);
		}
	}
