...
public class ClamRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ClamEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelclam(), 0.5f) {
	...
	public static class Modelclam extends EntityModel<Entity> {
		...
		public Modelclam() {
			...
			bb_main.setTextureOffset(15, 16).addBox(-1.5F, -4.0F, -1.4F, 3.0F, 3.0F, 3.0F, 0.0F, false);
