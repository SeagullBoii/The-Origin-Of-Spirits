...
@OnlyIn(Dist.CLIENT)
public class TridacnaStaffRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TridacnaStaffItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<TridacnaStaffItem.ArrowCustomEntity> {
		...
		@Override
		public void render(TridacnaStaffItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(TridacnaStaffItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
