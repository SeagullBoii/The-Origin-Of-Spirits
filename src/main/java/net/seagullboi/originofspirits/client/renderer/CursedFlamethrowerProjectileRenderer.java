...
@OnlyIn(Dist.CLIENT)
public class CursedFlamethrowerProjectileRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CursedFlamethrowerProjectileItem.arrow,
					renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<CursedFlamethrowerProjectileItem.ArrowCustomEntity> {
		...
		@Override
		public void render(CursedFlamethrowerProjectileItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks,
		...
		@Override
		public ResourceLocation getEntityTexture(CursedFlamethrowerProjectileItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
