...
public class IllagersBaneEnchantment extends OriginofspiritsModElements.ModElement {
	@ObjectHolder("originofspirits:illagers_bane")
	public static final Enchantment enchantment = null;

	public IllagersBaneEnchantment(OriginofspiritsModElements instance) {
		super(instance, 136);
	}
