...
import net.seagullboi.originofspirits.procedures.SlashlingArmUseProcedure;
...
public class ItemAbilityKeybindKeyBinding extends OriginofspiritsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public ItemAbilityKeybindKeyBinding(OriginofspiritsModElements instance) {
		super(instance, 466);
	...
	public void initElements() {
		keys = new KeyBinding("key.originofspirits.item_ability_keybind", GLFW.GLFW_KEY_R, "key.categories.toos");
