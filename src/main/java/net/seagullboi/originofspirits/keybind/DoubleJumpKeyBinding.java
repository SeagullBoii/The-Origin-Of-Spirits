...
import net.seagullboi.originofspirits.procedures.DoubleJumpOnKeyPressedProcedure;
...
public class DoubleJumpKeyBinding extends OriginofspiritsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DoubleJumpKeyBinding(OriginofspiritsModElements instance) {
		super(instance, 954);
	...
	public void initElements() {
		keys = new KeyBinding("key.originofspirits.double_jump", GLFW.GLFW_KEY_SPACE, "key.categories.toos");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DoubleJumpOnKeyPressedProcedure.executeProcedure(Stream
