...
import net.seagullboi.originofspirits.procedures.OpenAccessoryGUIOnKeyPressedProcedure;
...
public class OpenAccessoryGUIKeyBinding extends OriginofspiritsModElements.ModElement {
		@OnlyIn(Dist.CLIENT)
		private KeyBinding keys;


	public OpenAccessoryGUIKeyBinding(OriginofspiritsModElements instance) {
		super(instance, 268);
	...
	public void initElements() {
		keys = new KeyBinding("key.originofspirits.open_accessory_gui", GLFW.GLFW_KEY_K, "key.categories.toos");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			OpenAccessoryGUIOnKeyPressedProcedure.executeProcedure(Stream
