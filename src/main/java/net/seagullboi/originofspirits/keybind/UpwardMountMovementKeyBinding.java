...
public class UpwardMountMovementKeyBinding extends OriginofspiritsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	private long lastpress = 0;

	public UpwardMountMovementKeyBinding(OriginofspiritsModElements instance) {
		super(instance, 959);
	...
	public void initElements() {
		keys = new KeyBinding("key.originofspirits.upward_mount_movement", GLFW.GLFW_KEY_SPACE, "key.categories.toos");
