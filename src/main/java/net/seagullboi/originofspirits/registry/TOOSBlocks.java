...
public class TOOSBlocks {
	...
	public static final RegistryObject<Block> ALCYONEUM = registerBlock("purple_alcyoneum", () -> new Block(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.BLUE_TERRACOTTA).sound(SoundType.CORAL).hardnessAndResistance(0.6F).setLightLevel(s -> 0).harvestTool(ToolType.PICKAXE)), TOOSItemGroup.BLOCK_GROUP);
	public static final RegistryObject<Block> ALCYONEUM_TOP = registerBlock("purple_alcyoneum_top", () -> new Block(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.BLUE_TERRACOTTA).sound(SoundType.CORAL).hardnessAndResistance(0.6F).setLightLevel(s -> 0).harvestTool(ToolType.PICKAXE)), TOOSItemGroup.BLOCK_GROUP);
	public static final RegistryObject<Block> DEEP_ALCYONEUM_TOP = registerBlock("deep_alcyonium_top", () -> new Block(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.PURPLE_TERRACOTTA).sound(SoundType.CORAL).hardnessAndResistance(0.6F).setLightLevel(s -> 0).harvestTool(ToolType.PICKAXE)), TOOSItemGroup.BLOCK_GROUP);
	public static final RegistryObject<Block> DEEP_ALCYONEUM = registerBlock("pink_alcyoneum", () -> new Block(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.PURPLE_TERRACOTTA).sound(SoundType.CORAL).hardnessAndResistance(0.6F).setLightLevel(s -> 0).harvestTool(ToolType.PICKAXE)), TOOSItemGroup.BLOCK_GROUP);
	public static final RegistryObject<Block> SHORE_ALCYONEUM = registerBlock("green_alcyoneum", () -> new Block(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.LIME_TERRACOTTA).sound(SoundType.CORAL).hardnessAndResistance(0.6F).setLightLevel(s -> 0).harvestTool(ToolType.PICKAXE)), TOOSItemGroup.BLOCK_GROUP);
	public static final RegistryObject<Block> SHORE_ALCYONEUM_TOP = registerBlock("shore_alcyonium_top", () -> new Block(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.LIME_TERRACOTTA).sound(SoundType.CORAL).hardnessAndResistance(0.6F).setLightLevel(s -> 0).harvestTool(ToolType.PICKAXE)), TOOSItemGroup.BLOCK_GROUP);
	...
	public static final RegistryObject<Block> ALCYONEUM_POLYPS = registerBlock("alcyonium_polyps", () -> new SeaPolypBlock(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.BLUE_TERRACOTTA).zeroHardnessAndResistance().sound(SoundType.CORAL).notSolid().doesNotBlockMovement().setLightLevel(s -> 0)), TOOSItemGroup.PLANT_GROUP);
	...
	public static final RegistryObject<Block> SHORE_ALCYONEUM_POLYPS = registerBlock("shore_alcyonium_polyps", () -> new SeaPolypBlock(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.LIME_TERRACOTTA).zeroHardnessAndResistance().sound(SoundType.CORAL).notSolid().doesNotBlockMovement().setLightLevel(s -> 0)), TOOSItemGroup.PLANT_GROUP);
    ...
    public static final RegistryObject<Block> LEAF_CORAL_FAN = BLOCKS.register("leaf_coral_fan", () -> new CoralFanBlock(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.GREEN).zeroHardnessAndResistance().setLightLevel(s -> 0).doesNotBlockMovement().tickRandomly().setOpaque((a, b, c) -> false).sound(SoundType.WET_GRASS)));
    public static final RegistryObject<Block> LEAF_CORAL_FAN_SIDE = BLOCKS.register("leaf_coral_fan_side", () -> new DeadCoralWallFanBlock(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.GREEN).zeroHardnessAndResistance().setLightLevel(s -> 0).doesNotBlockMovement().tickRandomly().setOpaque((a, b, c) -> false).sound(SoundType.WET_GRASS)));
	public static final RegistryObject<Block> LEAF_CORAL_SHELF = registerBlock("leaf_coral_shelf", () -> new TOOSCoralShelf(AbstractBlock.Properties.create(Material.CORAL, MaterialColor.GREEN).zeroHardnessAndResistance().setLightLevel(s -> 0).doesNotBlockMovement().tickRandomly().notSolid().setOpaque((a, b, c) -> false).sound(SoundType.WET_GRASS)), TOOSItemGroup.PLANT_GROUP);
