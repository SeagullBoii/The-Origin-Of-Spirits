...
public class TOOSItems {
    ...
    //Weapons
    public static final RegistryObject<Item> PISTOL = ITEMS.register("pistol", () -> new PistolItem(new Item.Properties().maxStackSize(1).maxDamage(400).group(OriginOfSpiritsCombatItemGroup.tab)));
    public static final RegistryObject<Item> SHOTGUN = ITEMS.register("shotgun", () -> new ShotgunItem(new Item.Properties().maxStackSize(1).maxDamage(700).group(OriginOfSpiritsCombatItemGroup.tab)));
    public static final RegistryObject<Item> REDSTONE_HANDGUN = ITEMS.register("redstone_handgun", () -> new RedstoneHandgunItem(new Item.Properties().maxStackSize(1).maxDamage(700).group(OriginOfSpiritsCombatItemGroup.tab)));
    ...
    //Music Disc
    public static final RegistryObject<Item> PINK_DESERT_MUSIC_DISC = ITEMS.register("music_disc_pink_desert", () -> new MusicDiscItem(13, TOOSSoundEvents.PINK_DESERT,new Item.Properties().group(OriginOfSpiritsMiscItemGroup.tab).rarity(Rarity.RARE)));
