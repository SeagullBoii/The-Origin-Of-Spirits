...
public class TOOSItems {
    ...
    public static final RegistryObject<Item> SWEET_POTATO = ITEMS.register("sweet_potato",
            () -> new BlockItem(net.seagullboi.originofspirits.registry.TOOSBlocks.SWEET_POTATOES.get(), new Item.Properties()
                    .food(new Food.Builder().hunger(3).saturation(0.5f).build()).group(OriginOfSpiritsFoodItemGroup.tab)));

    //Weapons
    public static final RegistryObject<Item> TRIDACNA_SPEAR = ITEMS.register("tridacna_spear",
            () -> new TridacnaSpearItem(ModItemTier.TRIDACNA,-1,-2.6f, new Item.Properties().maxStackSize(1).rarity(ModRarities.SPITE).group(OriginOfSpiritsCombatItemGroup.tab)));
    public static final RegistryObject<Item> HEXED_SPEAR = ITEMS.register("hexed_spear",
            () -> new HexedSpearItem(ModItemTier.CURSED_STEEL,-1,-2.6f, new Item.Properties().maxStackSize(1).group(OriginOfSpiritsCombatItemGroup.tab)));
    public static final RegistryObject<Item> EYE_CANNON = ITEMS.register("eye_cannon",
            () -> new EyeCanonItem(new Item.Properties().maxStackSize(1).maxDamage(1200).group(OriginOfSpiritsCombatItemGroup.tab)));
