...
public class TOOSBiomes {
    public static final DeferredRegister<Biome> BIOMES = DeferredRegister.create(ForgeRegistries.BIOMES, OriginOfSpirits.MOD_ID);
    public static final RegistryObject<Biome> SACRED_PLAINS = BIOMES.register("sacred_plains", () -> makeSacredPlains(() -> TOOSConfiguredSurfaceBuilders.SACRED_PLAINS, 0.125f, 0.05f));
    public static final RegistryObject<Biome> ABYSS = BIOMES.register("abyss", () -> makeAbyss(() -> TOOSConfiguredSurfaceBuilders.ABYSS, 0.125f, 0.05f));
    public static final RegistryObject<Biome> COLORFUL_ABYSS = BIOMES.register("colorful_abyss", () -> makeAbyss(() -> TOOSConfiguredSurfaceBuilders.ABYSS, 0.125f, 0.05f));

    private static Biome makeSacredPlains(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
    ...
    private static Biome makeAbyss(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(surfaceBuilder);
        MobSpawnInfo.Builder mobspawninfo$builder = new MobSpawnInfo.Builder();
    ...
    private static Biome makeColorfulAbyss(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(surfaceBuilder);
        MobSpawnInfo.Builder mobspawninfo$builder = new MobSpawnInfo.Builder();
        BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-12887422).setWaterFogColor(-15590378)
                .withSkyColor(7972607).withFoliageColor(10387789).withGrassColor(9470285)
        ...
        return (new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.OCEAN).depth(-1.9995f).scale(0.35f).temperature(0.5f)
                .downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobspawninfo$builder.copy())
                .withGenerationSettings(biomegenerationsettings$builder.build()).build());
    }
